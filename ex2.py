...
class ProductionOptimizer:
    ...
    def display_menu(self):
        ...
        print("8. Візуалізація та збереження графіка")
        print("9. Вихід")
        print("="*60)
...
Постановка задачі:
Знайти такі значення технічних параметрів виробництва, які мінімізують загальні витрати або максимізують прибуток при дотриманні технологічних обмежень та бюджетних лімітів.
...
- Для максимізації прибутку: функція прибутку 
...
7. Візуалізація:
- Побудова графіка оптимальних параметрів
